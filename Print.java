...
//			System.out.println("Database Connected....");
	...
	public void getData()
	{
		try 
		{
			...
			res=stat.executeQuery("select * from library.books");
		} 
		catch (Exception e) {
	...
	public void printData()
	{
		try
		{
			while(res.next())
			{
				...
				System.out.println(res.getString("book_name"));
	...
	public static void main(String[] args) {
		...
		System.out.println("2. To edit existing book details");
		System.out.println("3. To remove an existing bookr");
		System.out.println("4. To print details of all bookdetails");
